...
Command: npx gltfjsx@6.2.16 walk2.glb 
*/

import React, { useEffect, useRef } from 'react'
import { useGLTF, useAnimations } from '@react-three/drei'

export function Walk2Model(props) {
  const group = useRef()
  const { nodes, materials, animations } = useGLTF('/models/walk2.glb')
...
useGLTF.preload('/models/walk2.glb')
